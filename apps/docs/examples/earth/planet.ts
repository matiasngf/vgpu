...
export const EARTH_TUNING = {
  /** Matches `<Canvas camera={{ fov: 40, position: [0, 0, 8] }}>` in the original. */
  camera: { fov: 40, near: 0.1, far: 200, radius: 8, minRadius: 1.25, maxRadius: 24 },
  /** Planet radius 1, atmosphere shell 1.02 — the same 2% offset as the three.js meshes. */
...
/** Sun direction for a rotation in degrees, mirroring the experiment's leva control. */
