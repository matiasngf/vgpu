...
/** Three decorrelated fbm samples, used to warp a domain without three separate calls at the call site. */
...
/** Remaps `value` from one range to another without clamping, like the GLSL original. */
