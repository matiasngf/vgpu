...
//
// three.js got this with `side: BackSide`. vgpu's pipelines do not expose a cull
// mode, so the shader discards every front-facing fragment instead — for a convex
